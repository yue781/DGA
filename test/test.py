...
test_paras = {
    ...
    20: ['cvrp20.txt', 10000, 128],
    50: ['vrp50_1w.txt', 10000, 128],
    100: ['vrp100_1w.txt', 1, 1],
    200: ['vrp200_1w.txt', 2048, 128],
    300: ['vrp300_9928.txt', 1024, 128],
    500: ['vrp500_5000.txt', 256, 128],
    1000: ['vrp1000_test_lkh.txt', 1, 1],
}
##########################################################################################
# parameters
